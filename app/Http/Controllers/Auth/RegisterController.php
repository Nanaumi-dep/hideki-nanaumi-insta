...
class RegisterController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $redirectTo = '/';    // ROOT URI (http://localhost) redirect to login page
    ...
    protected function create(array $data)
    {
        ...
        $user = User::create([
            ...
            # Example: $user['name' => 'Terry Jackson', 'email' => 'Terry.Jackson@gmail.com', 'password' => '1jo353413FRTQQ54']
        ]);
