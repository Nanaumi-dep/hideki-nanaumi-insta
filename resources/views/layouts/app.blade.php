        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                        {{-- Search ber here. Show it when the user logs in --}}
                        {{-- Note that the search field only available for logged-in users. --}}

                        @auth
                            @if (! request()->is('admin/*'))
                                {{-- Not show up in the admin side --}}
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                                ...
                                <li class="nav-item dropdown">
                                    <button id="account-dropdown" class="btn shodow-none nav-link" data-bs-toggle="dropdown">
                                        @if (Auth::user()->avatar)
                                    ...
                                    <div class="dropdown-menu dropdown-end" aria-labelledby="account-dropdown">
                                        {{-- Admin Control --}}
                                        @can('admin')
