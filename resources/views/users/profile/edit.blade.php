    ...
    <div class="row justify-content-center">
        <form action="{{ route('profile.update') }}" method="POST" class="bg-white shadow rounded-3 p-5" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-auto align-self-end">
                    ...
                    <div class="form-text" id="avatar-info">
                        Acceptable formats: jpg, jpeg, png, and gif only.
                        <br>
            ...
            <div class="mb-3">
                ...
                @error('email')
                    <p class="tex-tander small">{{ $message }}</p>
                @enderror
            </div>

            <div class="mb-3">
                <lable class="form-label.fw-bold">Introduction</lable>
                <textarea name="introduction" id="introduction" rows="5" class="form-control" placeholder="Describe yourself">{{ old('introduction', $user->intrduction) }}</textarea>
                @error('introduction')
                    <p class="tex-tander small">{{ $message }}</p>
                @enderror
            </div>
